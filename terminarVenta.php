...
$sentencia = $base_de_datos->prepare("INSERT INTO tbl_juegos_vendidos(id_juego, id_venta, cantidad) VALUES (?, ?, ?);");
$sentenciaExistencia = $base_de_datos->prepare("UPDATE tbl_juegos SET stock = stock - ? WHERE id = ?;");
